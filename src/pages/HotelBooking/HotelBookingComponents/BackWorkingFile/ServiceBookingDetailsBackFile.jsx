...
import { adultsQuantity1, childrenQuantity1, ipAddressSave, reponseHotelDetails, roomQuantity, saveHotelBookResponseData, saveIPAddress, savePerHotelRecord, saveRoomPerData, saveRoomsMultipleData, valueSaveFalse } from '../atom/atom';
...
const ServiceBookingDetails = ({ setIdComponent }) => {
  ...
  const [demoIp_Address, setDemoIp_Address] = useState('')
  ...
  const selectMultipleRoomFun = (roomData) => {
    ...
    if (saveRooms.includes(roomData)) {
      ...
      setSaveRooms([...saveRooms, roomData])
    }
  };

  let roomNoOfQuantity1 = 3;
  ...
  console.log(modifyArrRoom, 'modifyArrRoom =============')

  // Loop modifyArrRoom based on roomNoOfQuantity
  ...
  // Now duplicatedArray contains the duplicated objects
    ...
    if (saveRooms.length > 0) {
      ...
      let config = {
        ...
        body: {
          ...
          "EndUserIp": demoIp_Address,
          "TraceId": TraceId,
          "HotelRoomsDetails": [...modifyArrRoom],
        }
      }
      APIRequest(
        config,
                          ...
                          <div className="rmSelect__card--left">
                            <div className="rmType">
                              ...
                              <ul className="rmTypeList appendTop10 vertical">
                                ...
                                <li className="rmTypeList__item">
                                  <span className="makeFlex column column-text"><span className="rmTypeList__item--text">
                            ...
                            <div className="rmSelect__card--row">
                              <div className="rmSelect__card--rowLeft">
                                <div className="rmRatePlan">
                                  <div className="makeFlex end flexWrap"><span className="rmRatePlan__rec appendRight3">{roomData?.AvailabilityType}</span></div>
                              ...
                              <div className="rmSelect__card--rowRight">
                                ...
                                taxes &amp; fees
                                  ...
                                  <ButtonBook label={'SELECT ROOM'}
                                    activeBtn={saveRooms.includes(roomData) ? 'activeBtn' : ''}
