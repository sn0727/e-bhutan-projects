...
export default function MoneyRequestStatusContent() {
  ...
  const [isReceived, setIsReceived] = useState('all');
  ...
  const SendRequestWalletTransaction = async () => {
    ...
    let config = {
      ...
      body: {
        ...
        status: "all",
        data: "R001012",
        startDate: "2023-10-10T18:30:00.000Z",
        endDate: "2023-10-20T18:30:00.000Z"
      }
    };
    APIRequest(
      config,
        ...
        <Paper sx={{ width: '100%', overflow: 'hidden' }}>
          <div className='p-5'>
            <TableContainer sx={{ maxHeight: '100%' }}>
              <h3 className='text-left mb-4'>Money Request Status</h3>
              {
