                ...
                <div className="inputFeild">
                    <div className="enter-mobilenum">
                        <Autocomplete
                            ...
                            renderInput={(params) => <TextField {...params} className='autocomplete-custom-style-input' label="Select Insurer" />}
                        />
                    ...
                    <div className="enter-mobilenum select-plan">
                        <div className="enter-mobilenum">
                            <div className='set-p-relative'>
                                <input type="number" placeholder='Policy Number' onChange={(e) => setConsumerNumber(e.target.value)} className='enter-mobile-num bg-white border-cs InputTextColor' defaultValue={''} />
                                <span className='mt-1'>Policy Number must be 10 digits</span>
                            </div>
                        </div>
                    </div>
                </div>
